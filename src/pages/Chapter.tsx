...
export function Chapter() {
  ...
  const chapters = useQuery(api.queries.exploreFeed, { page: 1 });
  const firstSeries = chapters?.[0];
    ...
    <div className="min-h-screen grid-bg">
      <div className="max-w-7xl mx-auto px-8 py-12">
        ...
        <div className="flex justify-between items-center mt-12">
          <button className="neo bg-white px-6 py-3 font-bold text-black hover:scale-105 transition-transform">
            ← Previous
          </button>
          <button className="neo bg-white px-6 py-3 font-bold text-black hover:scale-105 transition-transform">
            Next →
